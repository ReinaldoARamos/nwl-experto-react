  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed md:left-1/2 md?top-1/2 z-10 flex md:h-[60vh] w-full md:max-w-[640px] md:-translate-x-1/2 md:-translate-y-1/2 flex-col overflow-hidden md:rounded-md bg-slate-700 outline-none inset-0 md:inset-auto">
